    ...
    if(i===0){
      ...
      panel.innerHTML=
        ...
        '<div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;align-items:start">'+
          ...
          '</div>'+
        '</div>';
      /* Parallax scroll for right image — GSAP ScrollTrigger */
      (function(){
          ...
          if(window.gsap&&window.ScrollTrigger){
            ...
            gsap.fromTo(img,
              ...
              {y:'12%',
               ease:'none',
               scrollTrigger:{
                 trigger:document.getElementById('parallax-form-wrap'),
                 start:'top bottom',
                 end:'bottom top',
                 scrub:true
               }
        ...
        if(window.ScrollTrigger){initParallax();}
        else{window.addEventListener('load',function(){setTimeout(initParallax,400);});}
      })();
    } else if(i===1){

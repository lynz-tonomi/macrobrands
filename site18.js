...
(function(){
  ...
  if(hdr){
    ...
    var moduleData=[
      {name:'SOURCING',sub:'Vendor Discovery',icon:'\u{1F50D}',x:16.7,y:12.5,color:'#00BFFF'},
      {name:'LOGISTICS',sub:'Route Optimization',icon:'\u{1F69A}',x:83.3,y:10,color:'#00BFFF'},
      {name:'FORECASTING',sub:'Demand Prediction',icon:'\u{1F4CA}',x:10,y:38,color:'#fff'},
      {name:'SCHEDULING',sub:'Production Planning',icon:'\u{1F552}',x:10,y:53,color:'#fff'},
      {name:'MONITORING',sub:'Real-time Alerts',icon:'\u{1F441}',x:84,y:38,color:'#fff'},
      {name:'ANALYTICS',sub:'Data Intelligence',icon:'\u{1F4C8}',x:84,y:53,color:'#00BFFF'},
      {name:'INVENTORY',sub:'Stock Management',icon:'\u{1F4E6}',x:33,y:82,color:'#fff'},
      {name:'COMPLIANCE',sub:'Regulatory Checks',icon:'\u{1F6E1}',x:51.7,y:85,color:'#fff'},
      {name:'TRACEABILITY',sub:'Batch Tracking',icon:'\u{1F517}',x:65,y:82,color:'#00BFFF'}
    ];

...
(function(){
  var icons = {
    ...
    '\ud83d\udcb0': '<svg viewBox="0 0 48 48" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="24" cy="24" r="18" class="lynz-svg-draw"/><path d="M24 12v24" class="lynz-svg-draw" style="animation-delay:.2s"/><path d="M18 18c0-3 2.7-5 6-5s6 2 6 5-2.7 4-6 4-6 1-6 4 2.7 5 6 5 6-2 6-5" class="lynz-svg-draw" style="animation-delay:.4s"/></svg>',
    '\ud83d\udd12': '<svg viewBox="0 0 48 48" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="10" y="22" width="28" height="22" rx="4" class="lynz-svg-draw"/><path d="M16 22v-8a8 8 0 0116 0v8" class="lynz-svg-draw" style="animation-delay:.3s"/><circle cx="24" cy="33" r="3" fill="#4FACFE" opacity="0" class="lynz-svg-pulse"/></svg>',
    '\ud83d\udcb8': '<svg viewBox="0 0 48 48" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="12" width="32" height="24" rx="3" class="lynz-svg-draw"/><circle cx="20" cy="24" r="6" class="lynz-svg-draw" style="animation-delay:.2s"/><path d="M36 18l8-8" stroke="#00BFFF" class="lynz-svg-draw" style="animation-delay:.5s"/><path d="M36 24l8-8" stroke="#00BFFF" class="lynz-svg-draw" style="animation-delay:.6s"/><path d="M36 30l8-8" stroke="#00BFFF" class="lynz-svg-draw" style="animation-delay:.7s"/></svg>',
